...
// Send a gift — deduct coins from sender, apply 65/35 split on credit
router.post('/send', authenticateToken, async (req, res) => {
  try {
    ...
    await user.updateOne({ $inc: { coins: -totalCost } });

    // Host receives 65% — stored for withdrawal calculation
