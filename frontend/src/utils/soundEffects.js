...
const REAL_SOUND_URLS = {
  ...
  laugh:   'https://actions.google.com/sounds/v1/human_voices/female_giggle.ogg',
  clap:    'https://actions.google.com/sounds/v1/crowds/applause.ogg',
  cheer:   'https://actions.google.com/sounds/v1/crowds/large_crowd_cheering.ogg',
  aww:     'https://actions.google.com/sounds/v1/cartoon/sad_trombone_short.ogg',
  ...
  boo:     'https://actions.google.com/sounds/v1/crowds/large_crowd_boo.ogg',
};
