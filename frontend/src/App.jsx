...
import { preloadIceConfig } from './utils/webrtcConfig';
...
export default function App() {
  ...
  // Also pre-fetch TURN credentials so by the time WebRTC actually needs
  // them they're already cached client-side.
  useEffect(() => {
    warmupServer();
    preloadIceConfig();
  }, []);
