...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await register(form);
      toast.success('🎉 Welcome to LyvStreem! You got 100 free coins!');
      navigate('/');
    } catch (err) {
        ...
        <div className="glass-card p-6 md:p-8">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="bg-brand-500/10 border border-brand-500/20 rounded-xl p-3 flex items-center gap-3">
              ...
              <p className="text-white/70 text-sm">Sign up and receive <span className="text-yellow-400 font-semibold">100 free coins</span> to send gifts!</p>
            </div>
