...
export default function HostDashboardPage() {
  ...
  return (
    <div className="p-4 md:p-6 max-w-5xl mx-auto">
      ...
      {/* Revenue Split Info */}
      <div className="glass-card p-4 mb-6 flex flex-col sm:flex-row gap-4 items-center border-brand-500/10">
        <div className="flex items-center gap-3 flex-1">
          <div className="w-12 h-12 rounded-xl bg-green-500/20 border border-green-500/20 flex items-center justify-center shrink-0">
            <span className="text-xl">💰</span>
          </div>
          <div>
            <p className="text-white font-semibold text-sm">Revenue Split</p>
            <p className="text-white/40 text-xs mt-0.5">Applied to all gifts received</p>
          </div>
        </div>
        <div className="flex gap-3 flex-wrap justify-center sm:justify-end">
          <div className="text-center bg-green-500/10 border border-green-500/20 rounded-xl px-4 py-2">
            <p className="text-green-400 font-display font-bold text-2xl">65%</p>
            <p className="text-white/50 text-xs mt-0.5">Your share</p>
          </div>
          <div className="text-center bg-dark-700/50 border border-white/5 rounded-xl px-4 py-2">
            <p className="text-white/40 font-display font-bold text-2xl">35%</p>
            <p className="text-white/30 text-xs mt-0.5">Platform fee</p>
          </div>
        </div>
      </div>
